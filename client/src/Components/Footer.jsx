          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/terms" className={`${linkClass} transition-colors text-sm sm:text-base`}>
                  Terms & conditions
                  </Link>
                </li>
                <li>
                  <Link to="/privacy-policy" className={`${linkClass} transition-colors text-sm sm:text-base`}>
                    Privacy Policy
                  </Link>
                </li>
                <li>
                  <Link to="/anti-discrimination-policy" className={`${linkClass} transition-colors text-sm sm:text-base`}>
